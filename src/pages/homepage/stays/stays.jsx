...
export default function Stays() {
  ...
  return (
    <div className="responsive-width">
      <div className="h-[65vh] relative flex flex-col     mb-20 mt-10">
        <img
          ...
          alt=""
        />
        <div className="header-gradient h-full w-full absolute z-10 top-0  rounded-2xl"></div>
          <div className="absolute   left-0 z-20  top-0 h-full w-full flex flex-col items-center justify-center gap-4">
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold text-gray-700 font-dm_sans">
              Book explore sleep
            </h1>
        ...
        <div className="w-full flex justify-center items-center">
          <div className="w-full  lg:-mt-10 lg:w-max">
            <SearchComponent />
          </div>
        </div>
      </div>
